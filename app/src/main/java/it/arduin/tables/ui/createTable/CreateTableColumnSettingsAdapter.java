 ...
 */
public class CreateTableColumnSettingsAdapter extends RecyclerView.Adapter<CreateTableColumnSettingsAdapter.ViewHolder>{

    static private List<ColumnSettingsHolder> data;
    Context c;

    public CreateTableColumnSettingsAdapter(List<ColumnSettingsHolder> d, Context c) {
        data = d;
        this.c = c;
    }
