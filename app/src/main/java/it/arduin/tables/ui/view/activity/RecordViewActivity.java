...
import it.arduin.tables.ui.presenter.RecordViewPresenter;
import it.arduin.tables.ui.presenter.RecordViewPresenterImpl;
import it.arduin.tables.utils.RecyclerViewUtils;
import it.arduin.tables.ui.view.adapter.RecordViewListAdapter;
...
public class RecordViewActivity extends BaseProjectActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(customQuery) fab.setVisibility(View.INVISIBLE);
    ...
    public void applyChanges(){
        ...
        try{
            ...
            Toast.makeText(this,getString(R.string.RecordViewActivity_update_error_message )+ " " + e.getMessage(), Toast.LENGTH_LONG).show();
        }
        db.close();
