...
public class DatabaseInfoActivity extends BaseProjectActivity {
    ...
    public void loadInfo(){
        ...
        Log.wtf("length",""+ dbh.getPath().length());
    ...
    public void showDeletePopup(){
        ...
        alert.setTitle(getString(R.string.DatabaseViewInfoActivity_delete_title));
        alert.setMessage(getString(R.string.DatabaseViewInfoActivity_delete_message));
