...
public class CustomRecordViewActivity extends ActionBarActivity {
    static Context c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_record_view);
        ...
        mRecyclerView = (RecyclerView)findViewById(R.id.RecordViewList);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mRecyclerView.setItemAnimator(new LandingAnimator());
        CustomRecordViewListAdapter myAdapter = new CustomRecordViewListAdapter(columnNames,columnValues, this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_custom_record_view, menu);
        return true;
    }
